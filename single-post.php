<div class="card theme-card p-2 pe-4 pb-3 my-2 rounded-0 border">
    ...
    <div class="d-flex  gap-1">
        ...
        <div class="">
            ...
            <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic expedita modi minus
                quia assumenda
                consequatur aliqua... <span class="text-primary cursor-pointer">Read More</span></p>
            <img class="rounded-4" src="https://pbs.twimg.com/media/G5xVl0iXMAE3zWt?format=jpg&name=medium" width="100%"
                alt="">
